...
if (_target == player) exitWith {systemChat "Вы не можете изгнать себя.";};
...
titleText [format["\nВы выгнали %1 из группы.",(name _target)], "PLAIN DOWN"];
...
titleText [format["\n\n %1 был удален из списка группы.",(name _target)], "PLAIN DOWN"];