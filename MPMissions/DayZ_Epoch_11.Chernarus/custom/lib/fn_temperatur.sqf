...
*/
	...
	private ["_looptime","_sun_factor","_building_factor","_vehicle_factor","_fire_factor","_water_factor","_snow_factor","_snowfall_factor","_rain_factor","_night_factor","_wind_factor","_camo_clothes","_height_mod","_difference","_hasfireffect","_isinbuilding","_isinvehicle","_snowfall","_raining","_sunrise"];
