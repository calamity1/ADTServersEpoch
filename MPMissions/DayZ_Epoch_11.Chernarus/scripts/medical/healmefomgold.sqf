...
if !("ItemGoldBar3oz" in magazines player) exitWith {cutText [format["Так, посмотрим... ничего серьезного. Цена 3 голды(скрепленные)"], "PLAIN DOWN"];};

if(DZE_ActionInProgress) exitWith { cutText [(localize "str_epoch_player_63") , "PLAIN DOWN"]; };
DZE_ActionInProgress = true;

player removeMagazine "ItemGoldBar3oz";
