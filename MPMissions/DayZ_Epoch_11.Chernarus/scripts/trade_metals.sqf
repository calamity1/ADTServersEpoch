...
// Стат меню...
{
	...
	_buy = player addAction [format["Trade %1 %2 for %3 %4",(_x select 3),(_x select 5),(_x select 2),(_x select 6)], "trade_items_wo_db.sqf",[(_x select 0),(_x select 1),(_x select 2),(_x select 3),(_x select 4),(_x select 5),(_x select 6)], (_x select 7), true, true, "",""];
...
_cancel = player addAction ["Cancel", "trade_cancel.sqf",["na"], 0, true, false, "",""];
