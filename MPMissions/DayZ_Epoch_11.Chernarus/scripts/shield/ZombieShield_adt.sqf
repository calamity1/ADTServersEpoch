...
sleep 1;
titleText ["Вы создаете зомбищит,будьте осторожны...","PLAIN DOWN"]; titleFadeOut 5;
...
titleText ["Зомбищит активировано.","PLAIN DOWN"]; titleFadeOut 5;
 // Joze Fix
_sounddist = 50;
_timeplay = 18;
...
titleText ["Зомбищит деактивировано.","PLAIN DOWN"]; titleFadeOut 5;