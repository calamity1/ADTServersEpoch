...
//settings
        ...
        switch(_WorldName)do{
              /*  case "napf":{
                ...
                case "chernarus":{
                _blacklistedAreas = [
                [[4724.00,8662.00,0],           500],
                [[6690.00,8238.00,0],           500],
                [[8528.00,8158.00,0],           500],
                [[11772.0,10074.0,0],           500],
                [[3857.00,4988.00,0],           500],
                [[10074.0,5910.00,0],           500],
                [[8122.35,13464.5,0],           500], // <-- no comma for last entry
				[[7994.00,9030.00,0],           500],
				[[9477.00,8157.00,0],           500],
				[[6864.00,5326.00,0],           500],
                [[10320.0,8758.00,0],           500],
                [[7160.00,9718.00,0],           500], // <-- no comma for last entry
				[[1684.00,10174.0,0],           500],
				[[1704.00,2854.00,0],           500],
				[[5672.00,2570.00,0],           500]
                ];
                };
                default{
                _blacklistedAreas = [
