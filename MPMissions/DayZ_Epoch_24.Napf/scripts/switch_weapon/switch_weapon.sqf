...
if (_cnt > 1) exitWith {cutText ["Нельзя менять оружие, если другой игрок рядом...", "PLAIN DOWN"];};
...
if (!(_newWpn in (_wpnDump select 0))) exitWith {cutText ["Этого оружия нет в сумке!", "PLAIN DOWN"];};
