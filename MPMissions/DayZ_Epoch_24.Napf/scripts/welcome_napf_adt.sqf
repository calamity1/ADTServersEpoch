...
_role1names = ["ADT-68 Epoch"];
_role2 = "Администраторы";
_role2names = ["Kemper", "Valerjanich", "GROM"];
_role3 = "Версия";
_role3names = ["DayZ Epoch Napf 1.0.4.2/103718"];
_role4 = "Группа ВКонтакте";
_role4names = ["vk.com/adt_68"];
_role5 = "Основные нововведения";
_role5names = ["Переделанные трейд зоны", "Сейфзоны 300 м"];
_role6 = "Основные нововведения";
_role6names = ["Миссии Автозаправка техники на заправках за золото"];
