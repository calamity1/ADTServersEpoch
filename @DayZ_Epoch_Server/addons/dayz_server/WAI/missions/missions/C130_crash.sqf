...
[[_position select 0, _position select 1, 0],3,1,"Random",5,"","Bandit2_DZ","Random",true] call spawn_group;
...
[nil,nil,rTitleText,"Медицинский C-130 потерпел крушение, теперь он под контролем бандитов!Проверьте вашу карту!!", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Выжившие осмотрели место крушения C-130!", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Выжившие не успели осмотреть место крушения C-130!", "PLAIN",10] call RE;
};
