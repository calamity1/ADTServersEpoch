...
[nil,nil,rTitleText,"Бандиты захватили вооруженный автомобиль. Проверьте Вашу карту!!", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Выжившие освободили военный автомобиль!", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Выжившие не успели освободить автомобиль!", "PLAIN",10] call RE;
};
