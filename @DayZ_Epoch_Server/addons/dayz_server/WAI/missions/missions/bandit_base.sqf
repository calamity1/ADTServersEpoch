...
[[_position select 0, _position select 1, 0],4,1,"Random",5,"","FR_OHara_DZ","Random",true] call spawn_group;
[[_position select 0, _position select 1, 0],4,1,"Random",5,"","FR_OHara_DZ","Random",true] call spawn_group;
[[_position select 0, _position select 1, 0],4,1,"Random",5,"","FR_OHara_DZ","Random",true] call spawn_group;
[[_position select 0, _position select 1, 0],4,1,"Random",5,"","FR_OHara_DZ","Random",true] call spawn_group;
...
[[[(_position select 0) + 10, (_position select 1) - 10, 0]],"M2StaticMG",0.8,"FR_OHara_DZ",1,2,"","Random",true] call spawn_static;
[[[(_position select 0) - 5, (_position select 1) + 5, 0]],"M2StaticMG",0.8,"FR_OHara_DZ",1,2,"","Random",true] call spawn_static;
[[[(_position select 0) + 5, (_position select 1) - 5, 0]],"M2StaticMG",0.8,"FR_OHara_DZ",1,2,"","Random",true] call spawn_static;
[[[(_position select 0) - 20, (_position select 1) + 20, 0]],"M2StaticMG",0.8,"FR_OHara_DZ",1,2,"","Random",true] call spawn_static;
[[[(_position select 0) + 20, (_position select 1) - 20, 0]],"M2StaticMG",0.8,"FR_OHara_DZ",1,2,"","Random",true] call spawn_static;
...
[nil,nil,rTitleText,"Бандиты построили базу! Проверьте вашу карту!", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Выжившие захватили базу бандитов!!", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Выжившие не успели захватить базу бандитов!", "PLAIN",10] call RE;
};
