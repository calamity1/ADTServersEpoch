...
[nil,nil,rTitleText,"Ящик с медикаментами бандитов был обнаружен!Проверьте вашу карту!!", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Выжившие не успели захватить ящик с медикаментами", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Выжившие захватили ящик с медикаментами!", "PLAIN",10] call RE;
};
