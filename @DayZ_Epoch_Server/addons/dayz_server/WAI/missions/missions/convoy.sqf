...
[nil,nil,rTitleText,"Конвой со стройматериалами был захвачен бандитами!", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Выжившие захватили конвой со стройматериалами!", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Выжившие не успели захватить конвой со строй материалами!", "PLAIN",10] call RE;
};
