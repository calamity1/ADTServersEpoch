...
[nil,nil,rTitleText,"Бандиты захватили медицинский MV-22! Проверьте Вашу карту!", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Выжившие освободили медицинский MV-22!", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Выжившие не успели освободить MV-22 вовремя!", "PLAIN",10] call RE;
};
