...
[nil,nil,rTitleText,"Группа бандитов только что приобрели вертолет! Проверьте вашу карту для расположения!", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Выжившие украли у бандитов вертолет!", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Выжившие не успели украсть вертолет!", "PLAIN",10] call RE;
};
