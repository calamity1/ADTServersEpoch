...
[nil,nil,rTitleText,"Бандиты получили ящик с оружием. Проверьте Вашу карту!!", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Выжившие отбили ящик с оружием у бандитов!", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Выжившие не успели забрать ящик с оружием!", "PLAIN",10] call RE;
};
