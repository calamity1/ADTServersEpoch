...
[nil,nil,rTitleText,"Бандитский вертолет взлетает с оружейным ящиком ! Сохраните и удержите груз!", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Выжившие захватили вертолет с оружейным ящиком", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Выжившие не успели захватить вертолет с оружейным ящиком", "PLAIN",10] call RE;
};
