...
[nil,nil,rTitleText,"Бандиты получили ящик оружия! Проверьте вашу карту для расположения!", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Выжившие захватили ящик с оружием!", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Выжившие не успели захватить ящик с оружием!", "PLAIN",10] call RE;
};
