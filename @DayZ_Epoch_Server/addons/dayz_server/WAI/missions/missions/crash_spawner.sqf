...
[nil,nil,rTitleText,"Бандиты разбились на вертолете! Проверьте вашу карту для расположения", "PLAIN",10] call RE;
...
if (_playerPresent) then {
	...
	[nil,nil,rTitleText,"Выжившие осмотрели место крушения!", "PLAIN",10] call RE;
} else {
	...
	[nil,nil,rTitleText,"Выжившие не успели осмотреть место крушения!", "PLAIN",10] call RE;
};
