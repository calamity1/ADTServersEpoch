...
/* *********************************www.infiSTAR.de********************************* */
/*  infiSTAR.de .dll path */  infiSTAR_DLL_PATH = "C:\server";    /* "" == empty == arma2oa directory */
...
/*  NORMAL ADMIN HERE     */ _NormalLevel_List =["10531396","9784772","0"]; //do not have a , at the end.
/*  SUPER ADMIN HERE      */ _SuperLevel_List = ["5733636","705348","10057092"]; //do not have a , at the end.
/*  BANNED PLAYER HERE    */ _BLOCKED =         ["0","0","0"]; //do not have a , at the end.
/* ********************************************************************************* */
/*  Top esc menu TXT      */ _TopOfESC = "ADT-68"; //do not use " in this text.
/*  Bottom esc menu TXT   */ _LowerTop = "by GROM, Valerjanich"; //do not use " in this text.
/*  Bottom esc menu TXT2  */ _LowerBottom = "dayz-adt.ru"; //do not use " in this text.
/*  Color esc menu TXT    */ _EscColor = [0.6,0,0,1];
/*  DebugMonitor TXT      */ _BottomDebug = "vk.com/adt_68"; //do not use " in this text.
...
[
	...
	"SCAR_L_STD_EGLM_TWS","M110_TWS_EP1","ItemMap_Debug","ItemCore","M136","Javelin","Stinger",
	"RPG7V","Strela","Igla","MetisLauncher","RPG18","SMAW","BAF_NLAW_Launcher",
	"Laserdesignator","M32_EP1","M79_EP1","Mk13_EP1"
];
/* ********************************************************************************* */
...
[
	...
	"MH60S","Ka137_PMC","Ka137_MG_PMC","Ka60_GL_PMC","Ka60_PMC","BAF_Apache_AH1_D","AW159_Lynx_BAF",
	"AH64D_Sidewinders","AV8B","Chukar","CruiseMissile1","CruiseMissile2",
	"MQ9PredatorB","Pchela1T","Su34","AH6J_EP1","Chukar_EP1","L39_TK_EP1",
	"MQ9PredatorB_US_EP1","Mi171Sh_rockets_CZ_EP1","Mi24_D_TK_EP1","Su25_TK_EP1","AAV","BMP2_Ambul_CDF",
	"BMP2_Ambul_INS","BMP2_CDF","BMP2_Gue","BMP2_HQ_CDF","BMP2_HQ_INS","BMP2_INS","M1A2_TUSK_MG",
	"ZSU_CDF","ZSU_INS","BMP2_HQ_TK_EP1","BMP2_TK_EP1","BMP2_UN_EP1","M113Ambul_TK_EP1","M113Ambul_UN_EP1",
	"M113_TK_EP1","M113_UN_EP1","M1A1_US_DES_EP1","M1A2_US_TUSK_MG_EP1","M2A2_EP1","M2A3_EP1","M6_EP1",
	"MLRS_DES_EP1","T34_TK_EP1","T34_TK_GUE_EP1","T55_TK_EP1","T55_TK_GUE_EP1","T72_TK_EP1","ZSU_TK_EP1",
	"BRDM2_ATGM_CDF","BRDM2_ATGM_INS","BRDM2_CDF","BRDM2_Gue","BRDM2_HQ_Gue","BRDM2_INS","BTR90","BTR90_HQ",
	"GRAD_CDF","GRAD_INS","GRAD_RU","LAV25","LAV25_HQ","BRDM2_ATGM_TK_EP1","BRDM2_HQ_TK_GUE_EP1","BRDM2_TK_EP1",
	"BRDM2_TK_GUE_EP1","BTR40_MG_TK_GUE_EP1","BTR40_MG_TK_INS_EP1","BTR40_TK_GUE_EP1","BTR40_TK_INS_EP1",
	"BTR60_TK_EP1","GRAD_TK_EP1","M1126_ICV_M2_EP1","M1126_ICV_mk19_EP1","M1128_MGS_EP1","M1129_MC_EP1",
	"M1130_CV_EP1","M1133_MEV_EP1","M1135_ATGMV_EP1","MAZ_543_SCUD_TK_EP1","BM21","BM21 GRAD"
];
/* ********************************************************************************* */
